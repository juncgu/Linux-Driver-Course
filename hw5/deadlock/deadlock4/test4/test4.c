...
void *pth1_handler(void *t){
    ...
    printf("***pth1 wants to do IOCMODE1, e2_ioctl()\n");
    rc = ioctl(fd_1, E2_IOCMODE1, 1);
    printf("***pth1 finishs IOCMODE1, e2_ioctl()\n");
    printf("Now device in MODE1\n");
    sleep(5);

    printf("***pth1 wants to write device, e2_write()\n");
    write(fd_1, buf, 10);
    printf("***pth1 finishes writing, e2_write()\n");
